...
\noindent Write an \texttt{R} function that implements this test where the reference distribution is normal. As a hint, you can create the empirical distribution and theoretical CDF using this code:
